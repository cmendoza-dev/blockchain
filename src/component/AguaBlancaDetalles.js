...
const AguaBlancaDetalles = () => {
  ...
  return (
    <div>
      <h1>Agua Blanca de La Arena</h1>
      <p>Ubicación: Cajamarca, Perú</p>
      <p>Recursos: Oro, Plata</p>
      <p>Etapa: Producción</p>
      <p>Monto mínimo de inversión: $400,000 USD</p>
      <p>Rentabilidad esperada: 15%</p>
      <p>Riesgo: Medio</p>
      <p>
        Descripción: Agua Blanca es un proyecto a cielo abierto con grandes
        reservas de oro y plata. Tiene un enfoque claro en el desarrollo a largo
        plazo y la extracción sostenible de minerales.
      </p>
      <input
        type="text"
        value={amount}
...
export default AguaBlancaDetalles;
